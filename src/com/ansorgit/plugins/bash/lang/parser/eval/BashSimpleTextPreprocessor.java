...
public class BashSimpleTextPreprocessor
  implements TextPreprocessor
{
  ...
  public boolean decode(String content, @NotNull StringBuilder outChars) {
    if (outChars == null) throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", new Object[] { "outChars", "com/ansorgit/plugins/bash/lang/parser/eval/BashSimpleTextPreprocessor", "decode" }));  Ref<int[]> sourceOffsetsRef = new Ref();
